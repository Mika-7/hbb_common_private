...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "Xcy123456".to_string());
        RwLock::new(map)
    };
    // pub static ref BUILTIN_SETTINGS: RwLock<HashMap<String, String>> = Default::default();
    pub static ref BUILTIN_SETTINGS: RwLock<HashMap<String, String>> = {
        let mut map = HashMap::new();
        map.insert("hide-network-settings".to_string(), "true".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rustdesk.huainf.cn"];
pub const RS_PUB_KEY: &str = "jZUDElw5740nF8SScUv0lyQJuJDuu41J9fqm2WVlltk=";
